...
public class MoneyTest
{
    ...
    public static Collection<Object[]> data() throws Exception
    {
        return Arrays.asList(new Object[][]{
                        ...
                        /*Not needed -> would be substraction
                        {new Money(-5, 05), new Money(-3, 10), new Money(-8, 15), 0},
                        {new Money(3, 50), new Money(-2, 49), new Money(0, 99), 0},
                        {new Money(3, 50), new Money(-2, 51), new Money(0, 99), 0},
                        {new Money(3, 50), new Money(-4, 50), new Money(-1, 0), 0},*/
                }
        );
    }
